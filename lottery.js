...
const CLAIM_EXPIRY_HOURS = Math.max(1, Number(process.env.WATCHER_LOTTERY_CODE_EXPIRY_HOURS || "168"));
...
const LOTTERY_PACKS = [
  ...
  {
    id: "the_road_trip_pack",
    name: "The Road Trip Pack",
    items: [
      { label: "Gasoline_Canister", qty: 1, fallback: "Gasoline_Canister", aliases: ["Gasoline_Canister"] },
      { label: "Car_Repair_Kit", qty: 1, fallback: "Car_Repair_Kit", aliases: ["Car_Repair_Kit"] },
      { label: "Tire_Repair_Kit", qty: 1, fallback: "Tire_Repair_Kit", aliases: ["Tire_Repair_Kit"] },
      { label: "Metal_Scrap_01", qty: 3, fallback: "Metal_Scrap_01", aliases: ["Metal_Scrap_01"] },
      { label: "Energy_Drink_Red_Ghoul", qty: 1, fallback: "Energy_Drink_Red_Ghoul", aliases: ["Energy_Drink_Red_Ghoul"] },
      { label: "CannedTuna", qty: 1, fallback: "CannedTuna", aliases: ["CannedTuna"] },
    ],
  },
  {
    id: "the_rain_check_pack",
    name: "The Rain Check Pack",
    items: [
      { label: "Raincoat_01", qty: 1, fallback: "Raincoat_01", aliases: ["Raincoat_01"] },
      { label: "HikingBoots_01", qty: 1, fallback: "HikingBoots_01", aliases: ["HikingBoots_01"] },
      { label: "Beanie_01", qty: 1, fallback: "Beanie_01", aliases: ["Beanie_01"] },
      { label: "Matches", qty: 1, fallback: "Matches", aliases: ["Matches"] },
      { label: "Candle_01", qty: 1, fallback: "Candle_01", aliases: ["Candle_01"] },
      { label: "Water_05L", qty: 1, fallback: "Water_05L", aliases: ["Water_05L"] },
    ],
  ...
  {
    id: "the_kitchen_raid_pack",
    name: "The Kitchen Raid Pack",
    items: [
      { label: "KitchenKnife", qty: 1, fallback: "KitchenKnife", aliases: ["KitchenKnife"] },
      { label: "Spoon", qty: 1, fallback: "Spoon", aliases: ["Spoon"] },
      { label: "CannedSpaghetti", qty: 1, fallback: "CannedSpaghetti", aliases: ["CannedSpaghetti"] },
      { label: "CannedPeach", qty: 1, fallback: "CannedPeach", aliases: ["CannedPeach"] },
      { label: "BakedBeans", qty: 1, fallback: "BakedBeans", aliases: ["BakedBeans"] },
      { label: "Beer", qty: 1, fallback: "Beer", aliases: ["Beer"] },
      { label: "Water_05L", qty: 1, fallback: "Water_05L", aliases: ["Water_05L"] },
    ],
  },
  {
    id: "the_woodsman_pack",
    name: "The Woodsman Pack",
    items: [
      { label: "Axe", qty: 1, fallback: "Axe", aliases: ["Axe"] },
      { label: "Wooden_Stick", qty: 3, fallback: "Wooden_Stick", aliases: ["Wooden_Stick"] },
      { label: "Animal_Skin", qty: 1, fallback: "Animal_Skin", aliases: ["Animal_Skin"] },
      { label: "Bone", qty: 1, fallback: "Bone", aliases: ["Bone"] },
      { label: "Bear_Meat_Cut", qty: 1, fallback: "Bear_Meat_Cut", aliases: ["Bear_Meat_Cut"] },
      { label: "Improvised_Backpack_Small", qty: 1, fallback: "Improvised_Backpack_Small", aliases: ["Improvised_Backpack_Small"] },
    ],
  },
  {
    id: "the_budget_sniper_pack",
    name: "The Budget Sniper Pack",
    items: [
      { label: "WeaponScope_ACOG", qty: 1, fallback: "WeaponScope_ACOG", aliases: ["WeaponScope_ACOG"] },
      { label: "Binoculars", qty: 1, fallback: "Binoculars", aliases: ["Binoculars"] },
      { label: "Military_Helmet_01_01", qty: 1, fallback: "Military_Helmet_01_01", aliases: ["Military_Helmet_01_01"] },
      { label: "CannedDogFood", qty: 1, fallback: "CannedDogFood", aliases: ["CannedDogFood"] },
      { label: "Water_05L", qty: 1, fallback: "Water_05L", aliases: ["Water_05L"] },
    ],
  ...
  {
    id: "the_gas_station_dinner_pack",
    name: "The Gas Station Dinner Pack",
    items: [
      { label: "Energy_Drink_Red_Ghoul", qty: 1, fallback: "Energy_Drink_Red_Ghoul", aliases: ["Energy_Drink_Red_Ghoul"] },
      { label: "Beer", qty: 2, fallback: "Beer", aliases: ["Beer"] },
      { label: "BakedBeans", qty: 1, fallback: "BakedBeans", aliases: ["BakedBeans"] },
  ...
  {
    id: "the_farmhand_pack",
    name: "The Farmhand Pack",
    items: [
      { label: "Shovel", qty: 1, fallback: "Shovel", aliases: ["Shovel"] },
      { label: "Wooden_Stick", qty: 2, fallback: "Wooden_Stick", aliases: ["Wooden_Stick"] },
      { label: "Rubber_band", qty: 1, fallback: "Rubber_band", aliases: ["Rubber_band"] },
      { label: "Rubber_sheet", qty: 1, fallback: "Rubber_sheet", aliases: ["Rubber_sheet"] },
      { label: "CannedPeach", qty: 1, fallback: "CannedPeach", aliases: ["CannedPeach"] },
      { label: "Boonie_Hat_01", qty: 1, fallback: "Boonie_Hat_01", aliases: ["Boonie_Hat_01"] },
  ...
  {
    id: "the_failed_robbery_pack",
    name: "The Failed Robbery Pack",
    items: [
      { label: "Crowbar", qty: 1, fallback: "Crowbar", aliases: ["Crowbar"] },
      { label: "Screwdriver_Small", qty: 1, fallback: "Screwdriver_Small", aliases: ["Screwdriver_Small"] },
      { label: "Safety_pin", qty: 4, fallback: "Safety_pin", aliases: ["Safety_pin"] },
      { label: "Tactical_Handgun_Holster_01", qty: 1, fallback: "Tactical_Handgun_Holster_01", aliases: ["Tactical_Handgun_Holster_01"] },
      { label: "Disposable_Mask", qty: 1, fallback: "Disposable_Mask", aliases: ["Disposable_Mask"] },
      { label: "Underpants_01", qty: 1, fallback: "Underpants_01", aliases: ["Underpants_01"] },
    ],
  ...
  {
    id: "the_fake_soldier_pack",
    name: "The Fake Soldier Pack",
    items: [
      { label: "Military_Shirt_01", qty: 1, fallback: "Military_Shirt_01", aliases: ["Military_Shirt_01"] },
      { label: "Military_Helmet_01_01", qty: 1, fallback: "Military_Helmet_01_01", aliases: ["Military_Helmet_01_01"] },
      { label: "CombatBoots", qty: 1, fallback: "CombatBoots", aliases: ["CombatBoots"] },
  ...
  {
    id: "the_sad_mechanic_pack",
    name: "The Sad Mechanic Pack",
    items: [
      { label: "Tire_Repair_Kit", qty: 1, fallback: "Tire_Repair_Kit", aliases: ["Tire_Repair_Kit"] },
      { label: "Metal_Scrap_01", qty: 4, fallback: "Metal_Scrap_01", aliases: ["Metal_Scrap_01"] },
      { label: "Rubber_sheet", qty: 2, fallback: "Rubber_sheet", aliases: ["Rubber_sheet"] },
      { label: "Bolts", qty: 3, fallback: "Bolts", aliases: ["Bolts"] },
      { label: "Nails", qty: 3, fallback: "Nails", aliases: ["Nails"] },
      { label: "Beer", qty: 1, fallback: "Beer", aliases: ["Beer"] },
    ],
  },
  {
    id: "the_wrong_bunker_pack",
    name: "The Wrong Bunker Pack",
    items: [
      { label: "Disposable_Mask", qty: 1, fallback: "Disposable_Mask", aliases: ["Disposable_Mask"] },
      { label: "Medical_Glove_01", qty: 1, fallback: "Medical_Glove_01", aliases: ["Medical_Glove_01"] },
      { label: "Magazine_M9", qty: 1, fallback: "Magazine_M9", aliases: ["Magazine_M9"] },
...
function buildRegistrationAnnouncement() {
  return [
    ...
    "",
    `A lottery draw takes place once every hour, 45 minutes after server restarts. One eligible player currently online will be randomly selected to receive one of ${LOTTERY_PACKS.length} mystery lottery packs.`,
    "",
...
async function handleLotteryStatus(message, config) {
  ...
  await message.reply([
    ...
    `Pack Count: ${LOTTERY_PACKS.length}`,
